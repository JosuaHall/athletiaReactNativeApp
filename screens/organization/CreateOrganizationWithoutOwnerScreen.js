// CreateOrganizationWithoutOwnerScreen.js
...
const CreateOrganizationWithoutOwnerScreen = ({ navigation }) => {
  ...
  const addNewOrganization = (navigation) => {
    if (logo === null || orgName === null) {
      ...
      dispatch(createOrganization(organization)); //3rd user created Organization, user becomes created_by
    }
  };
...
export default CreateOrganizationWithoutOwnerScreen;
